/**
 * @fileoverview ProductBrands: HTTP handlers (thin controllers).
 * @module modules/productBrands/productBrand.controller
 */
const asyncHandler = require('../../utils/asyncHandler');
const service = require('./productBrand.service');
const validation = require('./productBrand.validation');
