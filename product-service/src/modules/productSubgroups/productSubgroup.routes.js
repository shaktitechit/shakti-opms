/**
 * @fileoverview ProductSubgroups: Express router mounts + department RBAC.
 * @module modules/productSubgroups/productSubgroup.routes
 */
const { Router } = require('express');
const router = Router();
const { requireAuth } = require('../../middlewares/auth.middleware');
const { requireDepartment } = require('../../middlewares/dept.middleware');
const controller = require('./productSubgroup.controller');
