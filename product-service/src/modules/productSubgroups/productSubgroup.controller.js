/**
 * @fileoverview ProductSubgroups: HTTP handlers (thin controllers).
 * @module modules/productSubgroups/productSubgroup.controller
 */
const asyncHandler = require('../../utils/asyncHandler');
const service = require('./productSubgroup.service');
const validation = require('./productSubgroup.validation');
