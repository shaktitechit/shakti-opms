/**
 * @fileoverview ProductGroups: HTTP handlers (thin controllers).
 * @module modules/productGroups/productGroup.controller
 */
const asyncHandler = require('../../utils/asyncHandler');
const service = require('./productGroup.service');
const validation = require('./productGroup.validation');
