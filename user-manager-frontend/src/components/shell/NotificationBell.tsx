              ...
              <ul className="space-y-1" role="list">
                {rows.slice(0, 25).map((row, idx) => {
                  ...
                  const shellClassName = [
                    ...
                    tv.row,
                    unreadRow ? "bg-surface-muted" : "opacity-[0.97]",
                  ].join(" ");
                    ...
                    <>
                      ...
                      <span className="min-w-0 flex-1">
                        ...
                        <span className="mt-1 flex items-center gap-2 text-[10px] text-muted">
                          ...
                          {unreadRow ? (
                            <span className="rounded bg-primary px-1 py-px text-[9px] font-bold uppercase tracking-wide text-white">
                              Unread
                            </span>
                          ) : (
                  ...
                  return (
                    <li key={nid} role="listitem">
                      {unreadRow ? (
                        ...
                        <div
                          className={[shellClassName, "cursor-default hover:bg-surface-muted/60"].join(" ")}
                          role="group"
