...
import { DATE_FILTER_OPTIONS } from "../pagination/dateFilterUtils";
...
export function formatPeriodCaption(
  ...
  if (dateFilter && dateFilter !== "all") {
    if (dateFilter === "custom") {
      ...
      return DATE_FILTER_OPTIONS.find((opt: { id: string; label: string }) => opt.id === dateFilter)?.label ?? dateFilter;
    }
  } else {
